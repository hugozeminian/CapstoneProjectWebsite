...
const ReachOutIconsList = [
  { name: "faPhone", url: faPhone },
  { name: "faEnvelope", url: faEnvelope },
  { name: "faPaperPlane", url: faPaperPlane },
  ...
  { name: "faLinkedinIn", url: faLinkedinIn },
  { name: "faTiktok", url: faTiktok },
  { name: "faYoutube", url: faYoutube },
  { name: "faFacebookF_Hover", url: faFacebookF_Hover },
  { name: "faInstagram_Hover", url: faInstagram_Hover },
  { name: "faXTwitter_Hover", url: faXTwitter_Hover },
  { name: "faLinkedinIn_Hover", url: faLinkedinIn_Hover },
  { name: "faTiktok_Hover", url: faTiktok_Hover },
  { name: "faYoutube_Hover", url: faYoutube_Hover },
  { name: "faBlog", url: faBlog },
];

export default ReachOutIconsList;
