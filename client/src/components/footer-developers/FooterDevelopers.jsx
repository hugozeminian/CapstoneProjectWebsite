...
const DeveloperLink = ({ href, children }) => (
  <Typography variant="body2" component="a" href={href} target="_blank" rel="noopener noreferrer" color="text.secondary" mx="4px">
    {children}
  </Typography>
);
    ...
    <>
      <Typography
        ...
        {developersData.map((developer, index) => (
          <Fragment key={index}>
            <DeveloperLink href={developer.linkedin}>{developer.name}</DeveloperLink>
